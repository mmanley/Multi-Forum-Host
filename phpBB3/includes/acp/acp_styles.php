...
';
		...
		switch ($mode)
		{
			case 'style':
				...
				$this->frontend('style', array('details'), array('delete'));
			break;
			...
			case 'theme':
				...
				$this->frontend('theme', array('edit', 'details'), array('refresh', 'delete'));
			break;
			...
			case 'imageset':
				...
				$this->frontend('imageset', array('edit', 'details'), array('refresh', 'delete'));
			break;
		}
	}
	...
	function install_element($mode, &$error, $action, $root_path, &$id, $name, $path, $copyright, $store_db = 0)
	{
		...
		switch ($mode)
		{
			...
			case 'theme':
				...
				$sql_ary += array(
					'theme_storedb'	=> 1,
					'theme_data'	=> $this->db_theme_data($sql_ary, false, $root_path),
